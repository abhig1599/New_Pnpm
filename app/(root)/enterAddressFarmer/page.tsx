...
import styles from "./enterAddressFarmer.module.css";
// import loction from "../../../images/location.png";
// import marker from "../../../images/marker.png";
import Header from "../../../components/Header";function EnterAddressFarmer() {
  return (
    <div>
      <div className={styles.mainC}>
        ...
        <div className={styles.input}>
          <img src="/images/location.png" alt="" className={styles.image2} />
