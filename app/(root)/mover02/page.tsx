      ...
      <div className={styles.mainC}>
        ...
        <div className={styles.container}>
            ...
            <div className={styles.ltod}>
                <img src='/images/Locationicon.png' alt="" className={styles.img1}/>
                <img src='/images/Line 3.png' alt="" className={styles.img2}/>
                <img src='/images/Ellipse4.png' alt="" className={styles.img3} />
            </div>
